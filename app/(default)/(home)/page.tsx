                    ...
                    <div className="flex flex-col-reverse lg:flex-row justify-between gap-10">
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <ul className="ml-6 list-outside list-disc space-y-3">
                                ...
                                <li className="leading-loose">
                                    Office Rooms: CB 301E, <Link href="https://maps.app.goo.gl/DehmaHDnZ43ouHQx9" target="_blank" className="text-o-blue animated-underline break-words">Chow Yei Ching Building (周亦卿楼)</Link>, HKU and 1315, CDS, <Link href="https://surl.amap.com/1EWQWSi1p4XN" target="_blank" className="text-o-blue animated-underline break-words">590 Fangchun Road (香港大学张江校区)</Link>, Shanghai
                                </li>
                                <li className="leading-loose">
