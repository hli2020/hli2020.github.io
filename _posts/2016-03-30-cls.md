...
<div class="thecap" style="text-align:justify">Consider a 3-level spaticial pyramid matching. Each level is devided into different grids and we obtain the corresponding image representations within each grid. Then we __pool__ these results within each level and __concatenate__ the pooled representations among levels.</div>
</div>
