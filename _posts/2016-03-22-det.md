...
<div class="thecap" style="text-align:justify">Customized NMS scheme where the first K highly-overlapped boxes are averaged in terms of coordinates and scores. (Note that the diagram above is from the assignment specification document and takes a max-coordinate policy among boxes, which is **different** from mine. I am just too lazy to draw a new one. 
It will suffice.)</div>
</div>
