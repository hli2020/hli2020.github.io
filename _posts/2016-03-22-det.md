...
layout: post
comments: false
title:  "101 Pedestrian Detection using HOG"
excerpt: "We implement a 101 pedestrian detection system to solve the classical problem in computer vision. Old, antique, out of date features (HOG) are used as the representation features and fed into the SVM training to obtain a detector."
