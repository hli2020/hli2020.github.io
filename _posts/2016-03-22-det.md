...
> The baseline model equipped with the default settings provided in the skeleton code is 39.2; modify the threshold on different scales, it boosts to 52.5; change the NMS overlap, it goes to 55.76; switch from R-HOG to C-HOG, it becomes 58.38.
